				...
				<div class = "row" style = "margin-top:50px">	
					<div class = "col-md-4">
						...
						?>
						  ...
						  <li role="presentation" class="active"><a href="approval_approve.php?id=<?php echo $rec['id_dept']?>">Approve</a></li>
				...
				<div class="table-responsive">
					...
					?>
						...
						<tr>
								...
								<td>
									<a href='approve_view.php?id=<?php echo $rec['leaveid']; ?>'><input type='button' value='View' data-toggle="tooltip" data-placement="top" title="View to Approve" class='btn btn-info'/></a>
								</td>
							</tr>
					</tbody>
				<?php
