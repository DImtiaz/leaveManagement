				...
				<div class = "row" style = "margin-top:50px">	
					<div class = "col-md-4">
						...
						?>
						  ...
						  <li role="presentation" class="active"><a href="to_approval_approve.php?id=<?php echo $rec['id_dept']?>">Approve</a></li>
			...
			<div class="panel-body">
				<div class="table-responsive">
					<?php	
						...
						$sql = "SELECT * FROM employee, travel_ordr, program_head, department
