		...
		<div class="container-fluid">
				...
				<div class = "row" style = "margin-top:50px">	
					<div class = "col-md-4">
						...
						?>
						  <li role="presentation" class="active"><a href="to_view.php?id=<?php echo $rec['id_dept']?>">Pending</a></li>
						  <li role="presentation"><a href="to_approval_approve.php?id=<?php echo $rec['id_dept']?>">Approve</a></li>
						  <li role="presentation"><a href="to_approval_deny.php?id=<?php echo $rec['id_dept']?>">Deny</a></li>
						</ul>
					</div>
					<div class = "col-md-3">
						<h1>Travel Order</h1>
			...
			<div class="panel-body">
				<div class="table-responsive">
					<?php	
						...
						$sql = "SELECT * FROM employee, department, travel_ordr, accounting, program_head
