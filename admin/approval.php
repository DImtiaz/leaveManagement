			...
			<div class="row" style="margin-top:-50px;">
				...
				require ("../conn.php");   // Include the database class
					$select = "SELECT * FROM leaves, employee
									WHERE leaves.emp_id = employee.emp_id AND leaves.leaveid='$_GET[id]' ORDER BY emp_date ASC";
				...
				?>
					...
					<div class="col-md-12" style="margin-top:40px">
						...
						<div class="col-md-8 col-md-offset-4">
								<a href="dapproved.php?id=<?php echo $rec['leaveid'];?>"><input type='button' value='Approve' class='btn btn-info'/></a>
								<a href="ddeny.php?id=<?php echo $rec['leaveid'];?>"><input type='button' value='Deny' class='btn btn-primary'/></a>
								<a href="view-emp-pending.php"><input type = "button" value="Back" class="btn btn-default"/></a>
						</div>
					</div>
				<?php
					}
