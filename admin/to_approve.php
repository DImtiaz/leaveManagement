				...
				?>
					<div class="col-md-12" style="margin-top:40px">
						...
						<div class="col-md-6 col-md-offset-3">
								...
								<a href="to_ddeny.php?id=<?php echo $rec['to_id'];?>"><input type='button' value='Deny' class='btn btn-primary'/></a>
								<a href="to_view.php"><input type = "button" value="Back" class="btn btn-default"/></a>
							</div>
					</div>
				<?php
					}
