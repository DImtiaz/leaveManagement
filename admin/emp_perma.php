				...
				<div class = "row" style ="margin-top:50px">	
					<div class = "col-md-4">
						<ul class="nav nav-tabs">
							...
							<li role="presentation" class="active"><a href="emp_perma.php">Permanent</a></li>
	...
	<div class="col-md-12">
		<div class = "col-md-10">
					<?php
						...
						$welcome_view = "SELECT * FROM employee ,ldays WHERE employee.id_pos = ldays.id_pos 
												AND ldays.id_pos = '1' AND stat='1'";
						...
						$num_rows = mysql_num_rows($welcome_viewed);
								...
								if($num_rows == 1){
								echo "<h2> $num_rows Permanent Employee </h2>";}
								else
								echo "<h2> $num_rows Permanent Employees </h2>";
					?>
		</div>
		<div class="col-md-2">
				...
				<div class="table-responsive">
					<?php
						$sql="SELECT * FROM employee, ldays WHERE employee.id_pos = ldays.id_pos 
								AND ldays.id_pos = '1' AND stat='1' order by emp_date DESC LIMIT $start_from, $endlimit";
						$qry=mysql_query($sql);
					?>
