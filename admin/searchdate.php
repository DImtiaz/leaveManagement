...
<div class="container-fluid">
		<div class="container" style="margin-top:50px;">
			<div class="row">
					<form method="post" action="searchdate.php" class="form-inline" >
...
$a=$_POST['from'];
$b=$_POST['to'];
$qry = mysql_query ("SELECT * FROM employee, leaves, department
						where employee.id_dept = department.id_dept 
							AND leaves.emp_id = employee.emp_id
								AND leaves.date BETWEEN '$a' AND '$b'");
