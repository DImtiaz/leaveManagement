			...
			<div class="panel-body">
				<div class="table-responsive">
					<?php
						...
						$sql = "SELECT * FROM employee, department, vacation_log, approve_hr
									...
									AND approve_hr.hr_approve = '2' AND employee.stat = '1' AND vl_stat='0'";
						$qry=mysql_query($sql);
					...
					<tbody>
						<tr>
								...
								<td>
									<a href="vl_leftvacation.php?id=<?php echo $rec['v_id'];?>"><input type='button' value='View' data-toggle="tooltip" data-placement="top" title="View Content" class='btn btn-info'/></a>
								</td>
