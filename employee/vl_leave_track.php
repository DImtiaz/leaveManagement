...
<link rel="shortcut icon" href="../hrlogo.png">
	...
	<ul class="nav nav-tabs">
	  <li role="presentation" class="active"><a href="vl_leave_track.php">Recently Approve</a></li>
	  <li role="presentation"><a href="vl_all_approve.php">Done Approve</a></li>
	</ul>
	<br>
<div class="container-fluid">
	<div class = "row">
				...
				<div class="table-responsive">
					<?php
						...
						$sql = "SELECT * FROM employee, department, vacation_log, executive
									WHERE employee.emp_id = vacation_log.emp_id AND department.id_dept = employee.id_dept
