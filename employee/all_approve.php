...
<link rel="shortcut icon" href="../hrlogo.png">
	...
	<ul class="nav nav-tabs">
	  <li role="presentation"><a href="leave_track.php">Recently Approve</a></li>
	  <li role="presentation" class="active"><a href="all_approve.php">Done Approve</a></li>
	</ul>
	<br>
<div class="container-fluid">
	<div class = "row">
				...
				<div class="table-responsive">
					<?php
						...
						$sql = "SELECT * FROM employee, department, leaves, approve_hr, executive
									...
									AND employee.stat='1' 
									AND executive.exe_vp = '2' AND sl_stat='0' ORDER BY id_emp";
						$qry=mysql_query($sql);
					?>
